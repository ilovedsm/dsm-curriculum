...
코딩을 하다보면 캡슐화나, 가동성 때문에 파일을 여러개로 나누게 됩니다. CSS도 마찬가지 입니다. 만약 CSS파일이 200개가 넘는다면, 웹 브라우저는 200개에 해당하는 모든 파일들을 가져와야 합니다. 생각해보세요, 얼마나 무거울까요.

그리고 CSS와 js의 유연한 연결을 해야하는데 무거운 연결이 되고맙니다. 이를 해결하기 위해 css in js가 등장했습니다.
